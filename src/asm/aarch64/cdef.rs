...
*/
extern {
    fn rav1e_cdef_filter4_neon(
        dst: *mut u8, dsp_stride: isize, tmp: *const i16, pri_strength: i32, sec_strength: i32,
        dir: i32, damping: i32, h: i32,
    );

    fn rav1e_cdef_filter8_neon(
        dst: *mut u8, dsp_stride: isize, tmp: *const i16, pri_strength: i32, sec_strength: i32,
        dir: i32, damping: i32, h: i32,
    );

    fn rav1e_cdef_padding4_neon(
        tmp: *const i16, src: *const *mut u8, src_stride: isize, left: *const [isize;2], 
        top: *const [isize;2], h: i32,
    );

    fn rav1e_cdef_padding8_neon(
        tmp: *const i16, src: *const *mut u8, src_stride: isize, left: *const [isize;2], 
        top: *const [isize;2], h: i32,
    );
...
cpu_function_lookup_table!(
  ...
  default: None,
  [(NEON, Some(rav1e_cdef_find_dir_neon))]
);
...
mod test {
  ...
  test_cdef_fns!((1, 1), (1, 0), (0, 0), neon, "neon");
}
