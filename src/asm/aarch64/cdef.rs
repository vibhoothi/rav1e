...
extern {
    fn rav1e_cdef_filter8_neon(
      ...
      pri_strength: i32, sec_strength: i32, dir: i32, damping: i32, h: i32,
    );
    ...
    $(
        ...
        paste::item! {
          static CDEF_FILTER_FNS_NEON: [Option<CdefFilterFn>; 4] = {
            ...
            $(
              out[decimate_index($mode_x, $mode_y)] = Some([<rav1e_cdef_filter_$W x$H _neon>]);
             )*
            out
          };
        }
...
pub(crate) static CDEF_FILTER_FNS: [[Option<CdefFilterFn>; 4];
  ...
  out[CpuFeatureLevel::NEON as usize] = CDEF_FILTER_FNS_NEON;
  out
};
